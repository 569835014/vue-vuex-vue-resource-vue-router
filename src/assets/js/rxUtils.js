export const rxUtils = {
    ...
    /*后台api接口 线上 */
    apiUrl:'http://mobile.findaily.cn/',
    apiUrlFuLi: 'http://www.findaily.cn/',
    /*图片 测试*/
    // imgUrl: "http://jrjr-test.img-cn-hangzhou.aliyuncs.com",
    /*图片 线上*/
    imgUrl: "http://img.findaily.cn",
    /*直连接口*/
    zhiLianUrl: "http://zl.findaily.cn",//直连接口
    /*  H5分享链接 测试*/
    h5ShareUrl: "http://mtest.findaily.cn/appshare",
    /*H5分享链接 线上*/
    // h5ShareUrl: "http://jrwv.findaily.cn/appshare",
    /*H5webview 测试*/
    h5WvUrl: "http://wvtest.findaily.cn/webview",
    /*H5webview 线上*/
    // h5WvUrl: "http://jrwv.findaily.cn/webview",
    ...
    //阿里云图片参数
    imgArgs: 'w_1l_100p_q90_0-0-0bgc_90sh',
}, u = window.navigator.userAgent, readyStatus = false;
//阿里云图片根据设备设置
